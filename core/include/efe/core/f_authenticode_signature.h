#ifndef EFE_FEATURE_TYPE_AUTHENTICODE_SIGNATURE_INCLUDED
#define EFE_FEATURE_TYPE_AUTHENTICODE_SIGNATURE_INCLUDED
...
#endif // EFE_FEATURE_TYPE_AUTHENTICODE_SIGNATURE_INCLUDED
